...
const Forecast = ({ data, isActive, onClick }) => {
  ...
  return (
      <Box color={'white'} textShadow={'0 0 20px black'} 
      onClick={onClick} overflow='hidden' 
      cursor="pointer" bg={isActive ? bg_box : bg} h={140} w='150px' borderRadius={'lg'} p={2} textAlign={'center'}>
        <Center fontSize={'14'}>
